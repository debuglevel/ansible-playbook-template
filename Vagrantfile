...
Vagrant.configure("2") do |config|
    ...
    config.vm.define "backend01" do |backend01|
        ...
        backend01.vm.network "private_network", ip: "10.0.1.11"
    ...
    config.vm.define "backend02" do |backend02|
        ...
        backend02.vm.network "private_network", ip: "10.0.1.12"
    ...
    config.vm.define "greenlight01" do |greenlight01|
        ...
        greenlight01.vm.network "private_network", ip: "10.0.2.11"
    ...
    config.vm.define "loadbalancer01" do |loadbalancer01|
        ...
        loadbalancer01.vm.network "private_network", ip: "10.0.3.11"
    ...
    config.vm.define "storage01" do |storage01|
        ...
        storage01.vm.network "private_network", ip: "10.0.4.11"
